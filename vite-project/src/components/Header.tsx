const Header = () => {
    return (
        <div className="h-[124px] items-start inline-flex mb-[65px]">
            ...
            <div className="self-stretch pl-[3px] pt-[33px] pb-[9px] flex-col justify-end items-start gap-1 inline-flex">
                <div className="h-9 text-black text-3xl font-semibold font-['Poppins'] text-left">Live View</div>
                <div className="h-9 text-black text-xl font-normal font-['Poppins'] text-left">Follow your TM1 base life
